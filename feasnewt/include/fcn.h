...
#endif
#else
int o_fcn(double *obj, const double *x, const double *w, const double *t);
int o_fcn_gm(double *obj, const double *x, const double *w, const double *t);
int o_fcn_hm(double *obj, const double *x, const double *w, const double *t);
...
#ifdef CHECK
int o_cond(double *obj, const double *x, const double *w, const double *t);
#endif
#endif
...
#else
void h_only(double *h_obj, const double *x, const double *w, const double *t);
#endif
