...
const double my_w[6] = {1, 0, -0.5, 1, -0.5, 1};
const double my_t[9] = {1, 0, 0, 0, 1, 0, 0, 0, 1};
...
int main() {
  ...
  o_fcn(&obj, x, my_w, my_t);
  g_fcn(&obj, g_obj, x, my_w, my_t);
  h_fcn(&obj, g_obj, h_obj, x, my_w, my_t);
  ...
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n",      0.0, h_obj[4], h_obj[5], h_obj[6]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n",      0.0,      0.0, h_obj[7], h_obj[8]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n",      0.0,      0.0,      0.0, h_obj[9]);

  printf("\n");
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[10], h_obj[11], h_obj[12], h_obj[13]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[14], h_obj[15], h_obj[16], h_obj[17]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[18], h_obj[19], h_obj[20], h_obj[21]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[22], h_obj[23], h_obj[24], h_obj[25]);
  printf("\n");

  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[26], h_obj[27], h_obj[28], h_obj[29]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[30], h_obj[31], h_obj[32], h_obj[33]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[34], h_obj[35], h_obj[36], h_obj[37]);
  printf("% 5.4e\t% 5.4e\t% 5.4e\t% 5.4e\n", h_obj[38], h_obj[39], h_obj[40], h_obj[41]);
  return 0;
}
#endif
