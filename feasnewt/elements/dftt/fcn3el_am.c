...
static int g_fcnl(double *obj, double g_obj[3], const double x[12])
{
  ...
  *obj = f * loc4;
  ...
  g_obj[0] = tsqrt6*(f*df[0] + g*loc3);

  loc1 = g*matr[0];
  loc2 = g*matr[1];

  g_obj[1] = tsqrt6*(f*df[1] + loc2*matr[6] - loc1*matr[7]);
  g_obj[2] = tsqrt6*(f*df[2] + loc1*matr[4] - loc2*matr[3]);
  return 0;
}
		  ...
		  const double x[12])
{
  ...
  *obj = f * loc1;
  ...
  g_obj[0] = tsqrt6*(dobj_df*df[0] + dobj_dg*dg[0]);
  g_obj[1] = tsqrt6*(dobj_df*df[1] + dobj_dg*dg[1]);
  g_obj[2] = tsqrt6*(dobj_df*df[2] + dobj_dg*dg[2]);
  ...
  h_obj[0] = 1.5*(loc1*df[0] + loc2*dg[0] + dobj_df*(fmat[0] + t2 + aux[0]));
  h_obj[1] = 1.5*(loc1*df[1] + loc2*dg[1] + dobj_df*(fmat[1] + aux[1]));
  h_obj[2] = 1.5*(loc1*df[2] + loc2*dg[2] + dobj_df*(fmat[2] + aux[2]));

  loc1 = dg[1]*dobj_dfdg;
  loc2 = dg[1]*dobj_dgdg + df[1]*dobj_dfdg;
  h_obj[3] = 1.5*(loc1*df[1] + loc2*dg[1] + dobj_df*(fmat[3] + t2 + aux[3]));
  h_obj[4] = 1.5*(loc1*df[2] + loc2*dg[2] + dobj_df*(fmat[4] + aux[4]));

  loc1 = dg[2]*dobj_dfdg;
  loc2 = dg[2]*dobj_dgdg + df[2]*dobj_dfdg;
  h_obj[5] = 1.5*(loc1*df[2] + loc2*dg[2] + dobj_df*(fmat[5] + t2 + aux[5]));
  return 0;
}
#endif
...
int h_fcnl_0(double *obj, double g_obj[3], double h_obj[6], const double x[12])
{
  ...
  my_x[10] = x[10];
  my_x[11] = x[8];
  return h_fcnl(obj, g_obj, h_obj, my_x);
#endif
}
...
int h_fcnl_3(double *obj, double g_obj[3], double h_obj[6], const double x[12])
{
  ...
  return 0;
#else
  return h_fcnl(obj, g_obj, h_obj, x);
#endif
}
