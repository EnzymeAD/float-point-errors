...
int g_fcn(double *obj, double g_obj[6], const double x[6])
{
  ...
  *obj = f * loc1;
  ...
  adj_m[1] = -sqrt3*(f*df[1] - g*matr[2]);
  adj_m[2] = f*df[2] - g*matr[1];
  adj_m[3] = -sqrt3*(f*df[3] + g*matr[0]);
...
int h_fcn(double *obj, double g_obj[6], double h_obj[21], const double x[6])
{
  ...
  *obj = f * loc1;
  ...
  adj_m[3] = -sqrt3*(dobj_df*df[3] + dobj_dg*dg[3]);
  ...
  J_B[1] = e1b*(loc1*df[3] + loc2*dg[3] + dobj_df*aux[5] + dobj_dg);

  loc1 = dg[1]*dobj_dfdg;
  loc2 = dg[1]*dobj_dgdg + df[1]*dobj_dfdg;
  J_A[2] = e2b*(loc1*df[1] + loc2*dg[1] + dobj_df*(fmat[0]+ftmat[2]+aux[4]));
  J_B[2] = e1b*(loc1*df[2] + loc2*dg[2] + dobj_df*aux[3] - dobj_dg);
  J_B[3] = e2b*(loc1*df[3] + loc2*dg[3] + dobj_df*(fmat[1] + aux[6]));

  loc1 = dg[2]*dobj_dfdg;
  loc2 = dg[2]*dobj_dgdg + df[2]*dobj_dfdg;
  J_C[0] = loc1*df[2] + loc2*dg[2] + dobj_df*(fmat[2] + ftmat[0] + aux[7]);
  J_C[1] = e1b*(loc1*df[3] + loc2*dg[3] + dobj_df*(ftmat[1] + aux[8]));

  loc1 = dg[3]*dobj_dfdg; 
  loc2 = dg[3]*dobj_dgdg + df[3]*dobj_dfdg;
  J_C[2] = e2b*(loc1*df[3] + loc2*dg[3] + dobj_df*(fmat[2]+ftmat[2]+aux[9]));
